            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  ...
                  className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl font-semibold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 text-center"
                >
                ...
                <Link
                  href="#features"
                  className="px-8 py-4 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm text-gray-900 dark:text-white rounded-2xl font-semibold text-lg border border-gray-200 dark:border-gray-700 hover:bg-white dark:hover:bg-gray-800 transition-all duration-300 hover:shadow-lg text-center"
                >
                  Learn More
                </Link>
              </div>
      ...
      <div id="features" className="relative py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group relative bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-r from-red-500 to-orange-500 text-white text-2xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  ⚡
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  AI-powered system that predicts and prevents developer burnout through behavioral pattern analysis.
                </p>
              </div>
            </div>
            ...
            <div className="group relative bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-2xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  📊
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Visualize productivity patterns and coding habits to understand work patterns and optimize performance.
                </p>
              </div>
            </div>
            ...
            <div className="group relative bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-500 text-white text-2xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  👥
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  See team collaboration patterns and velocity metrics to optimize team performance and identify potential issues.
                </p>
              </div>
            </div>
            ...
            <div className="group relative bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 text-white text-2xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  🔍
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Automatically generated retrospectives based on development data to identify improvements without manual analysis.
                </p>
              </div>
            </div>
            ...
            <div className="group relative bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-2xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  🔒
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Securely authenticate with GitHub and automatically synchronize repository data with privacy controls.
                </p>
              </div>
            </div>
            ...
            <div className="group relative bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-r from-indigo-500 to-blue-500 text-white text-2xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  📱
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Access analytics on mobile devices with responsive layouts and optimized touch interactions.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link
                href="/api/auth/signin"
                className="group relative px-10 py-4 bg-white text-blue-600 rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
              >
              ...
              <Link
                href="#features"
                className="px-10 py-4 bg-transparent border-2 border-white text-white rounded-2xl font-bold text-lg hover:bg-white hover:text-blue-600 transition-all duration-300"
              >
                Schedule Demo
              </Link>
            </div>
